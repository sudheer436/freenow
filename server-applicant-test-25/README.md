...
## Task 2 					completed
## Task 3 					completed
## Task 4 (optional)		Implemented basic spring security.(I can improve this development work If I get more time) 
...
Other add ons:
	...
	added the logger messages
	able to dockerize the application 

Note:
car and driver id are auto ghenerated no need to give id for creation
if entity class has a property with camelCase then use _ in data.sql for defining.
